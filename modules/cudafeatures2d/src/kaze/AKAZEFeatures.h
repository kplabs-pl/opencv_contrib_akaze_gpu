...
#include "../cuda/akaze_cudaImage.h"
#include "../cuda/cuda_akaze.h"
#include "fed.h"
...
public:
  Matcher()
      : maxnquery(0), descq_d(NULL), maxntrain(0), desct_d(NULL), dmatches_d(0),
        dmatches_h(0), pitch(0) {}
