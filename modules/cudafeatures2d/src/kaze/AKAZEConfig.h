...
using DescriptorType = cuda::AKAZE::DescriptorType;
using DiffusivityType = cuda::AKAZE::DiffusivityType;
...
struct AKAZEOptions {
  ...
  AKAZEOptions() {
      ...
      diffusivity = cuda::AKAZE::DIFF_PM_G2;
      descriptor = cuda::AKAZE::DESCRIPTOR_MLDB;
      descriptor_size = 0;
  ...
  DiffusivityType diffusivity;   ///< Diffusivity type
  ...
  DescriptorType descriptor;     ///< Type of descriptor
...
struct TEvolution {
  ...
  Mat Lflow;                    ///< Diffusivity image
  Mat Lt;                       ///< Evolution image
  Mat Lsmooth;                  ///< Smoothed image
  Mat Lstep;                    ///< Evolution step update
